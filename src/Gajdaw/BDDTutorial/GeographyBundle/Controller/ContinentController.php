...
class ContinentController extends Controller
{
     ...
     *
     * @Route("/", name="admin_continent_create")
     * @Method("POST")
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_continent_show', array('id' => $entity->getId())));
        }
    ...
    private function createCreateForm(Continent $entity)
    {
        $form = $this->createForm(new ContinentType(), $entity, array(
            'action' => $this->generateUrl('admin_continent_create'),
            'method' => 'POST',
        ));
     ...
     *
     * @Route("/new", name="admin_continent_new")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}", name="admin_continent_show")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}/edit", name="admin_continent_edit")
     * @Method("GET")
     * @Template()
     */
    ...
    */
    ...
    {
        $form = $this->createForm(new ContinentType(), $entity, array(
            'action' => $this->generateUrl('admin_continent_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     *
     * @Route("/{id}", name="admin_continent_update")
     * @Method("PUT")
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_continent_edit', array('id' => $id)));
        }
     ...
     *
     * @Route("/{id}", name="admin_continent_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('admin_continent'));
    }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_continent_delete', array('id' => $id)))
            ->setMethod('DELETE')
